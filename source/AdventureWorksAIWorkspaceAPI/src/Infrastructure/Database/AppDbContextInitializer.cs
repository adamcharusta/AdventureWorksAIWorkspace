    ...
    IWebHostEnvironment environment)
{
    ...
    private async Task SeedSampleReportForAdminAsync(CancellationToken cancellationToken)
    {
        ...
        // A polished, multi-turn sample report so a freshly seeded admin lands on a fully
        // populated workspace: an AI business summary, charts, a SQL audit trail, and a chat
        // history. The numbers mirror the shape of the AdventureWorks 2013 sales data and are
        // internally consistent (category revenue and the monthly trend both total $47,905,470).
