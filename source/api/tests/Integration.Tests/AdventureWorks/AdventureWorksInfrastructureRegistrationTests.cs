...
namespace AdventureWorksAIWorkspace.Integration.Tests.AdventureWorks;
...
public sealed class AdventureWorksInfrastructureRegistrationTests
{
    ...
    public void AddInfrastructureServices_Should_RegisterAdventureWorksQueryExecutor()
    {
        ...
        executor.Should().BeOfType<Infrastructure.Services.AdventureWorks.DapperAdventureWorksQueryExecutor>();
    }
}
